...
public class ItemCinoTool extends Item
{
    ...
    protected EnumCinoToolMaterial toolMaterial;

    protected ItemCinoTool(int par1, int par2, EnumCinoToolMaterial par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
